...
# Add this helper class to handle Decimal serialization
...
def lambda_handler(event, context):
    ...
    try:
        ...
        # Debug logging with DecimalEncoder
        print(f"Found {len(all_exercises)} exercises for {weighted} {muscle_group}")
        print("Available exercises:", json.dumps(all_exercises, cls=DecimalEncoder, indent=2))
